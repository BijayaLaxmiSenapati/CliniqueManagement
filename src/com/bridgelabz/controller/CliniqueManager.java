...
{
	public static final String DOCTORS_FILE="/home/adminstrato/BijayaWorkSpace/Basic"
			+ "/CliniqueManagement/src/com/bridgelabz/files/Doctor.json";
	public static final String PATIENTS_FILE="/home/adminstrato/BijayaWorkSpace/Basic"
			+ "/CliniqueManagement/src/com/bridgelabz/files/Patient.json";
	public static final String APPOINTMENT_FILE="/home/adminstrato/BijayaWorkSpace/Basic"
	...
	private static void doSelectedOption(int option) 
	{
		...
		case 11:
			...
			System.out.println(patientServiceImplementation.showPopularDoctor());
			break;
		case 12:
