...
public class PatientServiceImplementation implements PatientService
{
	...
	public void searchPatient()
	{
		...
		case 1:
			...
			break;
		case 2:
			System.out.println(searchPatientByMobileNumber());
			break;
		case 3:
	...
	public Doctor showPopularDoctor()
	{
		...
		for(int i=0;i<DoctorServiceImplementation.doctorsList.size();i++)
		{
			if(DoctorServiceImplementation.doctorsList.get(i).getCountOfPatients()==biggestCount)
			{
				...
				//return;
				return DoctorServiceImplementation.doctorsList.get(i);
			}
		}
		return null;
	...
	public void showPopularSpecialization()
	{
		...
		Doctor popularDoctor=showPopularDoctor();
		System.out.println("Popular specialization is:");
		System.out.println(popularDoctor.getSpecialization());
		CliniqueManager.showOptions();
	}
